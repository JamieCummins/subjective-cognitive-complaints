...
# spm t1 
spm_t1_raw_df <- read_csv("raw/spm_11052022.csv")

# rai t1 
rai_t1_raw_df <- read_csv("raw/rai_11052022.csv")

# questionnaires t1 
questionnaires_t1_raw_df <- read_csv("raw/questionnaires_11052022.csv")
...
con <-
  dbConnect(drv = RSQLite::SQLite(),
            dbname = paste0('raw/questionnaires_data_', format(Sys.Date(), "%d%m%Y"), '.sqlite'))
...
write_csv(full_raw_data_df, paste0('raw/questionnaires_', format(Sys.Date(), "%d%m%Y"), '.csv'))
